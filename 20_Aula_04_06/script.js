...
console.log(resultado); //Soulcode
//ou
console.log(Array.from(texto).join('')); //Soulcode
...
let resposta = inverterTexto(texto);
...
console.log(pet.toLowerCase()); //chloe, tudo minusculo

console.log(pet.toUpperCase()); //CHLOE, tudo maiusculo

//VALIDAÇÃO
let arquivo = 'musica.mp3';

// Verificar se a string termina com a palavra x 
console.log(arquivo.endsWith('.mp3')); 

//Verificar se a string inicia com a palavra x 
console.log(arquivo.startsWith('mus'));

let frase = "Eu comi arroz, batata e carne";
// Buscar se uma frase inclui um trecho
console.log(frase.includes("feijao")); //false
